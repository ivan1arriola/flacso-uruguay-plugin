 ...
 *
 * Conserva los campos de presentacion usados por el sitio pero excluye datos
 * de contacto estructurados que pertenecen al contexto editorial.
 */
...
final class Docente_REST_DTO {
    ...
    public static function transform_response($response, $handler, $request) {
        ...
        $is_item = preg_match('#^/flacso-docentes/v1/docentes/\d+/?$#', $route) === 1;
