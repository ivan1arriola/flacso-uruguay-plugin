    ...
    public static function render_unified_page(): void {
        ...
        <div class="wrap flacso-unified-wrap">
            <header class="flacso-global-header">
                <h1><?php esc_html_e('Portada del sitio', 'flacso-main-page'); ?></h1>
                <p class="description">
            ...
            <div class="flacso-unified-container">
                <nav class="flacso-unified-tabs" role="tablist" aria-label="<?php esc_attr_e('Secciones de la portada', 'flacso-main-page'); ?>">
