...
class Flacso_Main_Page_Unified_Settings {
    ...
    private static function render_section_content(string $section_key, array $settings): void {
        switch ($section_key) {
            ...
            case 'eventos':
                ...
                break;
            case 'secciones':
                self::render_secciones_section($settings);
                break;
            case 'novedades':
    ...
    private static function render_posgrados_section(array $settings): void {
        ...
        <div class="flacso-form-group">
            ...
            <textarea id="posgrados_intro" name="posgrados[intro]" rows="5" class="regular-text"><?php echo esc_textarea($settings['posgrados']['intro'] ?? ''); ?></textarea>
        </div>
    ...
    private static function render_congreso_section(array $settings): void {
        ...
        <div class="flacso-form-group">
            ...
            <textarea id="congreso_content" name="congreso[content]" rows="6" class="regular-text"><?php echo esc_textarea($settings['congreso']['content'] ?? ''); ?></textarea>
        </div>
    ...
    private static function render_quienes_section(array $settings): void {
        ...
        <div class="flacso-form-group">
            ...
            <textarea id="quienes_content" name="quienes[content]" rows="6" class="regular-text"><?php echo esc_textarea($settings['quienes']['content'] ?? ''); ?></textarea>
        </div>
