(function (wp) {
    ...
    function CvDocenteEdit(props) {
        ...
        return el(
            ...
            InspectorControls &&
                el(
                    ...
                    el(
                        ...
                        !isLoading &&
                            options.length === 0 &&
                            el(Notice, { status: 'warning', isDismissible: false }, 'Todavia no hay docentes publicados.'),
                        options.length > 0 &&
                            el(SelectControl, {
                                label: 'Docente',
                                value: docId || 0,
            ...
            ServerSideRender
                ? el(ServerSideRender, {
                      block: 'flacso-uruguay/cv-docente',
    ...
    registerBlockType('flacso-uruguay/cv-docente', {
        edit: CvDocenteEdit,
        save: function () {
            return null;
        },
