(function (blocks, element, components, blockEditor, serverSideRender, data) {
    ...
    const renderControl = (attrKey, attrConfig, attributes, setAttributes) => {
        ...
        if (type === 'select' && Array.isArray(attrConfig.options)) {
...
})(window.wp.blocks, window.wp.element, window.wp.components, window.wp.blockEditor || window.wp.editor, window.wp.serverSideRender, window.FLACSO_POS_BLOCKS || {});
