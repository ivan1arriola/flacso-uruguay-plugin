    ...
    function bindForm(wrapper) {
        ...
        form.addEventListener("submit", async function (ev) {
            ...
            var eventoData = {
                ...
                plataforma_reunion: String(wrapper.dataset.eventoPlataformaReunion || "zoom").trim(),
                reunion_join_url: String(wrapper.dataset.eventoReunionJoinUrl || wrapper.dataset.eventoZoomJoinUrl || "").trim(),
                zoom_join_url: String(wrapper.dataset.eventoZoomJoinUrl || wrapper.dataset.eventoReunionJoinUrl || "").trim(),
