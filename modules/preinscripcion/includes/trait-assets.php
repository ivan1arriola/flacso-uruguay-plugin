...
trait FLACSO_Formulario_Preinscripcion_Assets {
    public function enqueue_assets_formulario($info) {
        ...
        wp_enqueue_style('flacso-formulario-styles', $assets_url . 'styles.css', array('intl-tel-input-css', 'country-select-js-css'), '1.0.4');
        ...
        wp_enqueue_script('flacso-formulario-script', $assets_url . 'scripts.js', array('jquery', 'intl-tel-input-js', 'country-select-js'), '1.0.9', true);
