...
$team_file = $root . '/modules/oferta-academica/includes/class-academic-team-admin.php';
...
team_scope_assert(file_exists($team_file), 'debe existir el editor de equipos académicos');
